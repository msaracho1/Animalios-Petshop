...
$title = 'Agregar producto - Animalios';
...
<div class="panel">
  <div class="panel__body">
    <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
      <h1 class="page-title" style="margin:0;">Agregar producto</h1>
    ...
    <form method="POST" action="<?= htmlspecialchars(route('admin.products.store'), ENT_QUOTES, 'UTF-8') ?>" class="form" style="margin:14px 0 0; max-width:780px;">
      ...
      <div class="form__row">
        ...
        <textarea id="descripcion" name="descripcion"><?= htmlspecialchars((string)old('descripcion'), ENT_QUOTES, 'UTF-8') ?></textarea>
      </div>

      <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
        <div class="form__row">
          <label for="precio">Precio</label>
          <input id="precio" type="number" step="0.01" name="precio" value="<?= htmlspecialchars((string)old('precio', '0'), ENT_QUOTES, 'UTF-8') ?>" required>
        </div>
